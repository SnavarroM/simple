<nav class="navbar navbar-expand-lg nnavbar-dark bg-dark custom-nav simple-nav-dark">
    <div class="container-fluid container-backend">
        ...
        <a class="navbar-brand" target="_blank" href="https://simple.gob.cl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul>
                    ...
                    Lunes a Jueves de  8:30hrs a 17:30hrs, Viernes de 8:30hrs a 16:30hrs.</li>
                    <br>
                    <h5>Herramientas de Apoyo</h5>
                    <li>Link de <a href="https://ejemplos.simple.digital.gob.cl/" target="_blank">Biblioteca de Ejemplos</a></li>
                    <li>Link de <a href="https://validador.simple.gob.cl" target="_blank">Validador de Procesos</a></li>
                    <br>
                    <h5>Recursos de Apoyo</h5>
                    <li>Link de <a href="https://simple.gob.cl" target="_blank">Sitio Web de SIMPLE</a></li>
                    <li>Link de <a href="https://simple.gob.cl/ayuda/" target="_blank">Preguntas Frecuentes</a></li>
                </ul>
            </div>

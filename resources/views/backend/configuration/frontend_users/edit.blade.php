                ...
                route('backend.configuration.frontend_users.store')}}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="is_disabled" id="si" value="1" <?= $form->is_disabled || $expirado ? 'checked' : '' ?> />
                                <label for="si" class="form-check-label">Si</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="is_disabled" id="no" value="0" <?= !$form->is_disabled && !$expirado ? 'checked' : '' ?> />

...
Route::middleware(['auth_user'])->group(function () {
    Route::middleware('check_email_cu')->group(function () {
    ...
    Route::post('/perfil', 'Auth\LoginController@saveMyAccount')->name('perfil.save');
...
//    Route::get('/terminos-y-condiciones', 'HomeController@terminosFront')->name('front.terminos');
    ...
    Route::middleware('check_seguimiento_cu')->group(function () {

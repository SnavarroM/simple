    ...
    public function editar_campo_form(Request $request, $campo_id = NULL)
    {
        ...
        if($request->has('datos')) {
            ...
            try {
                ...
                $validationExeption = [];
                $validationExeption[$campo->nombre] = 'Ha ocurrido un error al procesar el campo '.$campo->etiqueta.', si ha adjuntado un archivo, asegúrese de que el formato sea el correcto.';
                throw ValidationException::withMessages($validationExeption);
            }
        }

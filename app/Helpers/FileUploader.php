...
class FileUploader
{
    ...
    function handleUpload($uploadDirectory, $replaceOldFile = FALSE)
    {
        ...
        $filename = $this->getUniqueRandomName();
        ...
        if (!$replaceOldFile && file_exists($uploadDirectory . $filename . '.' . $ext)) {
            $filename = $nombre_random.Carbon::now()->timestamp;
        }
    ...
    function getUniqueRandomName() {
        ...
        $randomName = $this->generate_string($permitted_chars, 20);
        return $randomName;
    }
